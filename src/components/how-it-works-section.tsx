    ...
    <section className="px-5 py-10  w-full bg-white">
      <div className="max-w-7xl mx-auto flex flex-col items-center gap-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 w-full">
          ...
          <div className="border border-zinc-200 rounded-md p-6 lg:p-10 flex flex-col gap-6">
          ...
          {/* SDK Integration */}
          <div className="bg-blue-50 rounded-md p-6 lg:p-10 flex flex-col gap-6 justify-between">
            <h3 className="text-2xl lg:text-4xl font-normal text-zinc-900 leading-tight lg:leading-10">
              SDK Integration
            </h3>
