...
export function TrustedBySection() {
  return (
    <section className="flex flex-col gap-10 items-center justify-center px-5 py-16  w-full">
      ...
      <div className="flex flex-col gap-12 lg:gap-16 items-center justify-center w-full max-w-7xl">
        {/* First row of logos */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-16 items-center justify-items-center w-full">
        ...
        {/* Second row of logos */}
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 lg:gap-16 items-center justify-items-center w-full">
          <div className="relative h-12 lg:h-16 w-36 lg:w-52 col-span-2 md:col-span-1">
            <Image
          ...
          <div className="relative h-12 lg:h-14 w-32 lg:w-48 col-span-2 md:col-span-1">
            <Image
      ...
      <div className="bg-blue-700 flex flex-col sm:flex-row gap-4 lg:gap-5 items-center justify-center px-6 lg:px-10 py-6 lg:py-10 rounded-xl w-full max-w-7xl mt-8">
